...
export default function FileSystemCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setIsDirectory(initialValues.isDirectory);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new FileSystem(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FileSystemCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
